...
public class SelectGameModeView extends GridPane{
    ...
    private void layoutNodes(){
        ...
        GridPane.setConstraints(randomFillButtonFrame,2,18,20,4);
        GridPane.setConstraints(loadPiecesFrame,26,18,20,4);
        GridPane.setConstraints(loadSaveGameFrame,52,18,20,4);
        ...
        this.getChildren().addAll(fillBoardRandomlyButton,loadInPieceLayoutButton,loadSavedGameButton,returnToMenuButton, randomFillButtonFrame, loadPiecesFrame, loadSaveGameFrame);
